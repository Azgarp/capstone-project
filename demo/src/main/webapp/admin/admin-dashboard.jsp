    ...
    <div class="container-fluid container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="/admin/admin-dashboard.jsp">Home</a>
          </li>
          <li class="nav-item">
            ...
            <div class="d-md-flex justify-content-center pb-5">
              ...
              <div class="col-md-4 col-xl-4">
                <div class="card bg-primary order-card">
                  ...
                  <form name="checkBillForm" action="/admin/checkBill" hidden="true" method="get">
      				<input hidden type="submit" value="/admin/checkBill"/></form>
                </div>
              </div>
